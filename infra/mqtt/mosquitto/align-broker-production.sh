...
topic read hidrowave/+/rule_executed
topic read hidrowave/+/procedure_finished
...
topic write hidrowave/+/procedure/cmd
...
topic read hidrowave/${DEVICE_ID}/procedure/cmd
